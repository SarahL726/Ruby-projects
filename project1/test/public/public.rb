...
$VALID_SYNSETS = "/Users/sarah.l/OneDrive/UMD/sophomore/fall/CMSC330/cmsc330fall20/project1/inputs/public_synsets_valid"
$INVALID_SYNSETS = "/Users/sarah.l/OneDrive/UMD/sophomore/fall/CMSC330/cmsc330fall20/project1/inputs/public_synsets_invalid"
$VALID_HYPERNYMS = "/Users/sarah.l/OneDrive/UMD/sophomore/fall/CMSC330/cmsc330fall20/project1/inputs/public_hypernyms_valid"
$INVALID_HYPERNYMS = "/Users/sarah.l/OneDrive/UMD/sophomore/fall/CMSC330/cmsc330fall20/project1/inputs/public_hypernyms_invalid"
$STUDENT_TEST = "/Users/sarah.l/OneDrive/UMD/sophomore/fall/CMSC330/cmsc330fall20/project1/inputs/student_test"
...
class PublicTests < MiniTest::Test
    ...
    def test_public_synsets_add
        ...
        assert_equal(false, @synsets.addSet(2, ["haha%haah"]))
    end
    ...
    def test_public_commandline
        ...
        assert_equal({:recognized_command => :lookup, :result => ["a"]},
                     parser.parse("lookup 3"))
    end

    def test_student_synsets_add_empty
        assert_equal(false, @synsets.addSet(0, []))
    end

    def test_student_synsets_load_valid_invalid
        assert_nil(@synsets.load($VALID_SYNSETS))
        assert_equal([1, 2, 3, 4, 5, 6, 7, 8], @synsets.load($INVALID_SYNSETS))
    end

    def test_student_synsets_load_multiple_valid
        assert_nil(@synsets.load($VALID_SYNSETS))
        assert_nil(@synsets.load($STUDENT_TEST))
    end
